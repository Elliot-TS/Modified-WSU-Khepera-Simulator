...
public abstract class RobotController implements Controller
{
    ...
    /*
     * Returns the xPosition of the robot
    */
    public int getRobotXPosition(){
        return state.getRobotCoordinates().x;
    }

    /*
     * Returns the yPosition of the robot
    */
    public int getRobotYPosition(){
        return state.getRobotCoordinates().y;
    }
    ...
    */
    public float getRobotAngle(){
        return state.getRobotCoordinates().alpha;
	} // RobotController
    
    // Test
    public RobotCoordinates getRobotCoordinates(){
        return state.getRobotCoordinates();
    }
}
